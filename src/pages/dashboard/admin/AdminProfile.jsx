...
const AdminProfile = () => {
    ...
    return (
        <div className='w-2/3 lg:w-2/3 mx-auto shadow-lg p-6 flex flex-col justify-center items-center gap-3'>
            <img className='w-2/3 lg:w-1/3 h-28' src={user?.photoURL} alt="profile-picture" />
